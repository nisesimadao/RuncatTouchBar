...
''',
    "expanded presentation lifecycle",
)
...
''',
    '''        button.isBordered = false
        ...
        button.widthAnchor.constraint(equalToConstant: 28).isActive = true
''',
    "force kill image tint preservation",
)
...
''',
    "stable process label typography",
)
